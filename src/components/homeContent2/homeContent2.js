...
class HomeContent2 extends Component {
    ...
    render() {
      ...
      return (
            ...
            <div className="arrow"><Link to="/asesoriati"><Image src={Arrow} /></Link></div>
            </div>
            </div>
            ...
            <div className="arrow"><Link to="/experiencia"><Image src={Arrow} /></Link></div>
            </div>
            </div>
            ...
            <div className="arrow"><Link to="/desarrolloweb"><Image src={Arrow} /></Link></div>
