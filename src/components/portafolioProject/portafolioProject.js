      ...
      return (
          <div>
              ...
              <div className="gridIntro"> 
                      <div className="navBack"> 
                        ...
                        <img src={LeftArrow} alt="Abstract"/> 
                          Portafilio / <span className="textBlue">{Proyects[x].name}</span>
            ...
            <div className="girdGalery" style ={ { backgroundImage: "url("+ProjectGal1+")" } }>
                ...
                <div className="galeryButton2"><img src={RightArrowWhite} alt="arrow"/> </div>
            ...
            <div className="gridPinfo" style ={ { backgroundImage: "url("+ProjectBg2+")" } }>
              <div className="infoText"><span className="textBlue">{Proyects[x].name}</span>{Proyects[x].info}</div>
