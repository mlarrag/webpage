...
class PortfolioProject extends Component {
    ...
    render() {
      ...
      return (
          <div>
            <MainMenu/>
            <div><Head name={Proyects[x].name} back={Proyects[x].back}/></div>
            
              <div className="gridIntro"> 
                      <div className="navBack"> 

                        <img src={LeftArrow} alt="Abstract"/> 
                          Portafilio / {Proyects[x].name}
                      ...
                      <div className="gridImgText">
                            ...
                            <div className="gridText">
                                  <div className="projTitle">{Proyects[x].desc}</div>
                                  <div className="projSubTitle"> {Proyects[x].type}</div>
            ...
            <div className="gridInfo">
              ...
              <div className="gridAbout">
                ...
                <div className="projText">{Proyects[x].about}</div>
                </div>
              <div className="gridCha">
                <div className="projSubTitle">Desafío</div>
                <div className="projText">{Proyects[x].chal}</div>
                </div> 
              
              </div>

            <div className="girdGalery" style ={ { backgroundImage: "url("+ProjectGal1+")" } }>
                <div className="galeryButton1"><img src={LeftArrow} alt="arrow"/> </div>
                <div className="galeryButton2"><img src={RightArrow} alt="arrow"/> </div>
            ...
            <div className="gridPinfo" style ={ { backgroundImage: "url("+ProjectBg2+")" } }>
              <div className="infoText"><p>{Proyects[x].info}</p></div>
